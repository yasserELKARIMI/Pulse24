        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h3 class="mb-4">Need a Service from Us?</h3>
                    <p class="mb-4">Contact us today so that we can schedule a time or video meeting with you, to discuss how we can be of help. Or contact to order our products</p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
